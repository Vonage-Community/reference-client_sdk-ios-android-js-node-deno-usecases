...
import { ActionProps, ContainerProps, defaultAction, defaultContainer, defaultText, TextProps } from './utils';
    ...
    return (
        <RootContainer className={className}>
            ...
            <ActionsContainer className={actionsClassName}>
                <Action className={`${actionClassName} ${anserClassName}`} onClick={answerCall} label={answerLabel} />
                <Action className={`${actionClassName} ${rejectClassName}`} onClick={rejectCall} label={rejectLabel} />
            </ActionsContainer>
        </RootContainer>
    );
};