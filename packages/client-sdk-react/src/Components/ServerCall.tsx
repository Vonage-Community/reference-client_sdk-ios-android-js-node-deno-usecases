...
import { ContainerProps, ActionProps, defaultContainer, defaultAction, TextProps, defaultText } from './utils';
...
export const ServerCall = ({
    ...
    if (isRinging) return (
        <RingingContainer className={className}>
            ...
            <RingingActionContainer className={actionClassName} label={cancelLabel} onClick={hangup} />
        </RingingContainer>
    );
    ...
    return (
        <RootContainer className={className}>
            <ActionContainer className={actionClassName} onClick={() => startCall(callContext)} label={label} />
        </RootContainer>
    );
};