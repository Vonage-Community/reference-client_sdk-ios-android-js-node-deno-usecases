  ...
  public: {
    Tables: {
      device_codes: {
        ...
        Relationships: [
          {
            foreignKeyName: "device_codes_device_id_fkey"
            columns: ["device_id"]
    ...
    Functions: {
      ...
      set_user_presence: {
        Args: {
          new_status: Database["public"]["Enums"]["presence_status"]
          new_availability: Database["public"]["Enums"]["availability_type"]
        }
        Returns: undefined
      }
    ...
    Enums: {
      availability_type: "VOICE" | "CHAT" | "ALL"
      presence_status: "AVAILABLE" | "OFFLINE" | "BUSY" | "DO_NOT_DISTURB"
    }
    CompositeTypes: {
      [_ in never]: never
    }
